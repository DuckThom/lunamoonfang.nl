        ...
        <div class="column-1">
            <div class="text-center">
                <p class="text-block">
                    ...
                    My native language is Dutch but on the internet I mostly speak/write in English. <br />
                    I am also learning Swedish in my spare time as I'm planning to move to Sweden in the future.<br />
                    <br />
                    My favourite programming languages are PHP (Primarily Laravel), HTML5, JS and CSS3 but I can also code in Java, C#, Swift, Ruby and Python.<br />
                    ...
                    The games I've been playing the most lately are Rocket League and GTA V but I also play games like Overwatch, Hearthstone, Halo, DOTA and Diablo.<br />
                    ...
                    My favourite radio station is <a href="http://3fm.nl" target="_blank">3FM</a> on the radio and <a href="https://twitch.tv/monstercat" target="_blank">Monstercat FM</a> on Twitch.<br />
                    Electronic music is my favourite genre.<br />
                    <br />
                    Which brings me to the next point, YouTube. <br />
                    I'm subscribed to a lot of channels but <a href="https://youtube.com/hatfilms" target="_blank">Hat Films</a>, <a href="https://youtube.com/yogscastsips" target="_blank">Sips</a> and <a href="https://youtube.com/yogscast" target="_blank">The Yogscast</a> are my favourites.<br />
                    <br />
                </p>
            </div>
        </div>
